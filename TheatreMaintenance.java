...
public class TheatreMaintenance {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to J12 Theatre Maintenance System");
	...
	public Customer takeInput() {
		...
		showName = sc.next();
		while(!(showName.equalsIgnoreCase("M") || showName.equalsIgnoreCase("e") || showName.equalsIgnoreCase("a") || showName.equalsIgnoreCase("n"))) {
		...
		int no = sc.nextInt();
		if(no>Screen.CAPACITY) {
			 do {
			    	System.out.println("As capacity is "+Screen.CAPACITY+" range for number of seats should be between 1 to "+Screen.CAPACITY);
					no=sc.nextInt();
					break;
				}while(!(no<Screen.CAPACITY));
				}
		if(no==0) {
	    do {
		...
		System.out.println("Enter the choice of number of seats");
